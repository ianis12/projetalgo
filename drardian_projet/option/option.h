...
//                   vaut lower, en majuscules si VALUE vaut upper, les laisser
//                   tels quels si VALUE vaut as-is;
...
//                              le ﬁchier FILE;
//    -o FILE ou --ouput=FILE : au lieu de la sortie standard, écrire résultat
//                              dans le ﬁchier FILE.
#ifndef OPTIONS__H
#define OPTIONS__H
...
extern int option(int argc, char **argv, bool *sort, bool *lowerCase,
    bool *upperCase, char **inputFileName,
