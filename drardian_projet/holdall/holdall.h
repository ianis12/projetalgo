...
//    structure de données, et alors en aucun cas pour réaliser de copies ou des
//    destructions d'objets éventuellement pointés par les adresses fournies, ou
//    par l'utilisation des fonctions fournies
...
//    nulle en cas de dépassement de capacité. Renvoie sinon zéro
...
extern int holdall_apply_context(holdall *ha,
    int (*fun)(void *ptr, void *result_funcontext),
