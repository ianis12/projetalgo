...
//    d'une méthode simple d'itération efficace sur ses éléments dans l'ordre 
//    de la liste, grâce à un pointeur d'élément courant qui peut soit avancer
...
int glosaries_load_file(glosaries *, FILE*);
char* glosaries_informations(glosaries*);
...
//    sinon
extern const void *glosaries_add(word *w, const void *xptr);
...
// glosaries_dispose: libère toutes les ressources associés à la structure de *g puis
//    affecte à *g la valeur NULL
